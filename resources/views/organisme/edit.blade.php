        ...
        <div class="form-group row">
          ...
          <div class="col-4">
            <div class="form-check form-check-inline">
              <input type="checkbox" class="form-check-input @error('visible_filtre') is-invalid @enderror" name="visible_filtre" id="visible_filtre" value="1"@if($organisme->visible_filtre) checked="checked" @endif />
