...
<table class="table table-hover">
    ...
    @php(array_push($done, $evenement->start))
      <tr class="row m-0">
        <td class="col-1">@if($evenement->end)<small class="text-muted"><i class="fas fa-chevron-right small"></i>&nbsp;{{ \Carbon\Carbon::parse($evenement->end)->translatedFormat('d M Y') }}</small>@endif</td>
